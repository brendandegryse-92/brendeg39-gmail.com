...
<body>
  <h1>Welcome to the NutrientStar-CIG data tool.</h1>
    ...
    <div class="vertical-menu">
      <ul>
          <li><a href="https://upgradeag.com/CIG/otherlogin.php"><strong>Login</strong></a></li>
          <li><a href="https://upgradeag.com/CIG/otherregister.php"><strong>Register</strong></a></li>
      </ul>
    </div>
      <hr>
    <div class ="logos">
