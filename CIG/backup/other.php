...
<body>
  ...
  ?>
  <div id="Grower">Active Grower: </div><button onclick="if (document.cookie.search('PrimeIDGrower')>=0) {location.href = 'edit.php';}">Edit Grower</button><button onclick="if (document.cookie.search('PrimeIDGrower')>=0) {location.href = 'otherfield.php';}">Add Field</button><br />
